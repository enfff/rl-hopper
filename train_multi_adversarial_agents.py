...
for seed in seeds:
    ...
    model = PPO('MlpPolicy', agent_env, seed=seed, learning_rate=lr)
    ...
    deception = SAC('MlpPolicy', deception_env, seed=seed, learning_rate=lr)
    ...
    model.save(f'deception_model_agent_dr_seed{seed}lr{lr}.mdl')
